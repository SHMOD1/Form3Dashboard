...
// Redacted: paste your own Mapbox public token here (used only for the optional
// satellite basemap layer and the address search box below — the main map runs
// on free MapLibre + Carto/OSM tiles without it).
const MAPBOX_TOKEN = '';
